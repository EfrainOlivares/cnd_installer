#
# This file is used to configure the clouds_and_dragons project. It contains
...
# permissions in most cases. You will also need to update the clouds_and_dragons
